...
class ControladorProductos{
	...
	static public function ctrMostrarProductosOptimizados($item, $valor, $optimizacion){

		$tabla = "inventario";

		if($optimizacion == "si"){
			$respuesta = ModeloProductos::MdlMostrarProductosOptimizados($tabla, $item, $valor);
		} else {
			$respuesta = ModeloProductos::MdlMostrarProductos($tabla, $item, $valor);
		}
