...
class ModeloProductos{
	...
	static public function MdlMostrarProductosOptimizados($tabla, $item, $valor){
	...
	static public function mdlBuscarProductosPorNombreOCodigo($q, $limit = 15){
	...
	static public function mdlTraerProductoDetalle($id){
		...
		// Si tú tienes arreglo de unidades en PHP, aquí podrías devolver el texto:
		// pero como es AJAX, puedes mapear en backend también.
		// Ejemplo simple:
		$unidadMap = [
			"1"=>"lb",
			"2"=>"kg",
		...
		$u = $p["unidadMedida"] ?? "";
		$p["unidad_texto"] = isset($unidadMap[$u]) ? $unidadMap[$u] : "";
